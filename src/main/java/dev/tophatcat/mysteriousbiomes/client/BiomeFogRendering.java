...
public class BiomeFogRendering {
    ...
    /**
     ...
     mixedColor = getFogBlendColorWater(level, player, x, y, z, event.getPartialTick());
     } else {
     ...
     @SubscribeEvent public static void setFogColor(final EntityViewRenderEvent.FogColors event) {
     ...
     @SubscribeEvent public static void renderFog(final EntityViewRenderEvent.RenderFogEvent event) {
     final Player player = Minecraft.getInstance().player;
