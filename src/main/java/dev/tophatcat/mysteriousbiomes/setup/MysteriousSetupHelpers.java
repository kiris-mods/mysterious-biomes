...
public class MysteriousSetupHelpers {
    ...
    public static Supplier<Block> setupSaplingBlock(String name, AbstractTreeGrower generator) {
        return RegHelpers.createBlockWithItem(new ResourceLocation(MysteriousBiomes.MOD_ID, name), MysteriousBiomes.ITEM_TAB,
            () -> new SaplingBlock(generator, Block.Properties.of(Material.WOOD).randomTicks().noCollission()),
            MysteriousContentSetup.BLOCKS, MysteriousContentSetup.ITEMS);
    }
    ...
    public static Supplier<Block> setupLeavesBlock(String woodType) {
        return RegHelpers.createBlockWithItem(new ResourceLocation(MysteriousBiomes.MOD_ID, woodType + "_leaves"),
            MysteriousBiomes.ITEM_TAB, () -> new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).noOcclusion()),
            MysteriousContentSetup.BLOCKS, MysteriousContentSetup.ITEMS);
    }
    ...
    public static Supplier<Block> setupPressurePlateBlock(String woodType) {
        return RegHelpers.createBlockWithItem(new ResourceLocation(MysteriousBiomes.MOD_ID, woodType + "_pressure_plate"),
            MysteriousBiomes.ITEM_TAB, () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,
                Block.Properties.of(Material.WOOD).strength(0.5F)),
            MysteriousContentSetup.BLOCKS, MysteriousContentSetup.ITEMS);
    }

    public static Supplier<Block> setupTrapdoorBlock(String woodType) {
        return RegHelpers.createBlockWithItem(new ResourceLocation(MysteriousBiomes.MOD_ID, woodType + "_trapdoor"),
            MysteriousBiomes.ITEM_TAB, () -> new TrapDoorBlock(Block.Properties.of(Material.WOOD).strength(3.0F).noOcclusion()),
            MysteriousContentSetup.BLOCKS, MysteriousContentSetup.ITEMS);
    }
    ...
    public static Supplier<Block> setupDoorBlock(String woodType) {
        return RegHelpers.createBlockWithItem(new ResourceLocation(MysteriousBiomes.MOD_ID, woodType + "_door"),
            MysteriousBiomes.ITEM_TAB, () -> new DoorBlock(Block.Properties.of(Material.WOOD).strength(3.0F).noOcclusion()),
            MysteriousContentSetup.BLOCKS, MysteriousContentSetup.ITEMS);
    }
}
