...
public class MysteriousBlockStateModelGenerator extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators modelGen) {
        ...
        modelGen.createGrassLikeBlock(MysteriousRegistry.BLOODIED_GRASS.get(),
            ...
            Variant.variant()
                .with(VariantProperties.MODEL, ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(MysteriousRegistry.BLOODIED_GRASS.get(), "", new TextureMapping()
                    .put(TextureSlot.BOTTOM, TextureMapping.getBlockTexture(MysteriousRegistry.BLOODIED_DIRT.get())).copyForced(TextureSlot.BOTTOM, TextureSlot.PARTICLE)
                    .put(TextureSlot.TOP, TextureMapping.getBlockTexture(MysteriousRegistry.BLOODIED_GRASS.get(), "_top"))
                    .put(TextureSlot.SIDE, TextureMapping.getBlockTexture(MysteriousRegistry.BLOODIED_GRASS.get(), "_snow")),
                    modelGen.modelOutput)));
