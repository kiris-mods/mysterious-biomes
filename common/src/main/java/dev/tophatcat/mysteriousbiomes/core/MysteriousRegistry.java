...
public class MysteriousRegistry {
    ...
    public static final Supplier<Block> BLOODIED_GRASS = MysteriousUtils.createBlock("bloodied_grass",
        Suppliers.memoize(() -> new BloodiedGrass(Block.Properties.of().strength(0.5F)
            .sound(SoundType.WET_GRASS).randomTicks())), true);
    public static final Supplier<Block> BLOODIED_DIRT = MysteriousUtils.createBlock("bloodied_dirt",
        Suppliers.memoize(() -> new Block(Block.Properties.ofFullCopy(Blocks.DIRT).strength(0.5F)
            .sound(SoundType.ROOTED_DIRT))), true);
    ...
    public static final Supplier<Block> BLOODWOOD_SAPLING
        = MysteriousUtils.makeSaplingBlock("bloodwood_sapling", new TreeGrower(
        "walnut", Optional.empty(), Optional.of(MysteriousFeatures.BLOODWOOD_TREE), Optional.empty()));
    ...
    public static final Supplier<Block> GHOSTLY_SAPLING
        = MysteriousUtils.makeSaplingBlock("ghostly_sapling", new TreeGrower(
        "walnut", Optional.empty(), Optional.of(MysteriousFeatures.GHOSTLY_TREE), Optional.empty()));
    public static final Supplier<Block> GHOSTLY_FLOOR_SIGN
        = MysteriousUtils.makeFloorSignBlock("ghostly_sign", MysteriousWoodType.GHOSTLY_TYPE);
    ...
    public static final Supplier<Block> SEEPING_SAPLING
        = MysteriousUtils.makeSaplingBlock("seeping_sapling", new TreeGrower(
        "walnut", Optional.empty(), Optional.of(MysteriousFeatures.SEEPING_TREE), Optional.empty()));
    public static final Supplier<Block> SEEPING_FLOOR_SIGN
        = MysteriousUtils.makeFloorSignBlock("seeping_sign", MysteriousWoodType.SEEPING_TYPE);
    ...
    public static final Supplier<Block> SORBUS_SAPLING
        = MysteriousUtils.makeSaplingBlock("sorbus_sapling", new TreeGrower(
        "walnut", Optional.empty(), Optional.of(MysteriousFeatures.SORBUS_TREE), Optional.empty()));
    public static final Supplier<Block> SORBUS_FLOOR_SIGN
        = MysteriousUtils.makeFloorSignBlock("sorbus_sign", MysteriousWoodType.SORBUS_TYPE);
    ...
    public static final Supplier<Block> WALNUT_SAPLING
        = MysteriousUtils.makeSaplingBlock("walnut_sapling", new TreeGrower(
        "walnut", Optional.empty(), Optional.of(MysteriousFeatures.WALNUT_TREE), Optional.empty()));
    public static final Supplier<Block> WALNUT_FLOOR_SIGN
        = MysteriousUtils.makeFloorSignBlock("walnut_sign", MysteriousWoodType.WALNUT_TYPE);
